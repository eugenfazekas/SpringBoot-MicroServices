...
public class AccountKeyRepositoryImpl  implements AccountKeyRepository{
	...
	public void createAccountKeyTable() {
		...
		final String  sql = "CREATE TABLE IF NOT EXISTS ACCOUNTKEYS (accountKey VARCHAR(36) NOT NULL, accountType VARCHAR(36) NOT NULL, email VARCHAR(64) PRIMARY KEY, UNIQUE KEY UK_email (email));";
		jdbc.execute(sql);
